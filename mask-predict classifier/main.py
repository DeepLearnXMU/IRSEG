...
def parse_args():
    ...
    # dataset settings
    parser.add_argument('--corpus', type=str, nargs='+',default=('aan/train.lower','aan/train.eg.20', 'aan/train.pre.order.txt'))
    parser.add_argument('--lang', type=str, nargs='+', help="the suffix of the corpus, translation language")
    parser.add_argument('--valid', type=str, nargs='+',default=('aan/val.lower','aan/val.eg.20','aan/val.pre.order'))
    ...
    parser.add_argument('--sub_id', type=str, default=None, help='ID of sub-train set.')
    ...
    parser.add_argument('--seed', type=int, default=1998, help='seed for randomness')
    ...
    parser.add_argument('--maximum_steps', type=int, default=3, help='maximum steps you take to train a model')
    ...
    parser.add_argument('--test', type=str, nargs='+', help='test src file',default=('aan/test.lower','aan/test.eg.20','aan/test.pre.order'))
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if len(args.load_from) == 1:
            load_from = 'models/{}.best.pt'.format(args.model)
    ...
    iteration = args.test[-1].split('.')[1].lstrip("iter")
    mark_file = "{}_{}_Done".format(args.mode,sub_id) 
