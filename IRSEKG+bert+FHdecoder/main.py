...
def parse_args():
    ...
    parser.add_argument('--d_pair', type=int, default=250, help='dimention size for FFN')
    ...
    parser.add_argument('--lambda1', type=float, default=1., help='hyperparameter to balance losses')
    parser.add_argument('--lambda2', type=float, default=1., help='hyperparameter to balance losses')
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.teacher is not None:
            teacher = torch.load(args.teacher, map_location='cuda')
        else:
            teacher = None
